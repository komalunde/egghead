...
var ToDoList = function (name) {
  ...
  this.demoList = ["Do stuff", "Make Front-End Magic", "COFFEE!!!!",
	 "Another important point", "Yet another thing to do"];
...
list.work = list.work || new ToDoList('work').init();
list.private = list.private || new ToDoList('private').init();*/
